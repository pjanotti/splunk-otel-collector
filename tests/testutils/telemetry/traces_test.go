...
func loadResourceTraces(t *testing.T) ResourceTraces {
...
func TestLoadTracesHappyPath(t *testing.T) {
	resourceTraces := loadResourceTraces(t)
...
func TestLoadResourcesInvalidItems(t *testing.T) {
